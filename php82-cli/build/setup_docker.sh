...
#	php8.2-gmagick \ provides more stable api but conflicts with imagick
#	php8.2-yac \ conflicts with php8.2-apcu
#	php8.2-swoole \ Missing files
#	php8.2-gearman \ Missing files
...
#module_url="https://gitlab.com/api/v4/projects/40908162/packages/generic/pdo_snowflake/latest/pdo_snowflake.zip"
...
#cp pdo_snowflake.ini /etc/php/8.2/mods-available/pdo_snowflake.ini
